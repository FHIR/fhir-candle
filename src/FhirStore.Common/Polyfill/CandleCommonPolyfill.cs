// <copyright file="CandleCommonPolyfill.cs" company="Microsoft Corporation">
...
namespace FhirCandle.Polyfill
{
    ...
    internal class ImmutableHashSet<T>
        where T : notnull
    {
        internal static HashSet<T> Create(IEnumerable<T> items)
        {
