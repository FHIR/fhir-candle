...
# Run all unit tests
dotnet test --configuration Release --framework net9.0 --no-restore --verbosity normal

# Run R4 Patient Search Tests
dotnet test --configuration Release --framework net9.0 --no-restore --verbosity normal --filter "FullyQualifiedName~fhir.candle.Tests.R4TestsPatient.PatientSearch"
